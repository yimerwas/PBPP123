...
// ==> Using power prior with fixed a0
// ==========================================


// Functions that can be used for formulating the BLMM model for the current data using power prior with fixed a0
functions {
}
...
model {
  ...
  // priors including constants
    // target += normal_lpdf(Intercept_0| 100, 10);
